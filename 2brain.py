...
print("Performing homing sequence...")
try:
    subprocess.run(['/usr/bin/python3', '/home/skynet/homing.py'], check=True)
    print("Homing complete.")
except subprocess.CalledProcessError as e:
    print(f"Failed to complete homing sequence: {str(e)}")
    sys.exit(1)  # Exit the script if homing fails
