...
initial_positions = {
    ...
    2: 108, 20: 140.88, 4: 88.8, 40: 136.80
}
...
while True:
    if not second_loop_active:
        ...
        while t <= math.pi:
            servo1.move(math.sin(t+0.3) * 30 + initial_positions[1])
            servo3.move(math.sin(t+0.3) * 30 + initial_positions[3])
    ...
    if second_loop_active:
        ...
        while t2 <= math.pi:
            servo2.move(math.sin(t2+0.3) * 30 + initial_positions[2])

            servo4.move(math.sin(t2+0.3) * 30 + initial_positions[4])
